...
buttons = [
            [
                InlineKeyboardButton("☘️ HOW TO USE ME ☘️", callback_data="help"),
            ],
            [
    ...
    if query.query == "SAF_ONE":
        answers.append(
            InlineQueryResultArticle(
                ...
                thumb_url="https://telegra.ph/file/bea91b4f8ac94f4c3fce5.jpg",
                input_message_content=InputTextMessageContent(f"{REPLY_MESSAGE}\n\n<b>© Powered By : \n@MarineBots | @MarineChats 👑</b>", disable_web_page_preview=True),
